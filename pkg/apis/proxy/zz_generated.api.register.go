...
var (
	...
	InternalKojiImageBuildPackageREST = builders.NewInternalSubresource(
		"kojiimagebuilds", "KojiImageBuildPackage", "package",
		func() runtime.Object { return &KojiImageBuildPackage{} },
	)
	// Registered resources and subresources
	ApiVersion = builders.NewApiGroup("proxy.art.openshift.io").WithKinds(
		InternalKojiImageBuild,
		InternalKojiImageBuildStatus,
		InternalKojiImageBuildPackageREST,
	)
...
type KojiImageBuildPackage struct {
	metav1.TypeMeta
	metav1.ObjectMeta
	Spec   KojiImageBuildPackageSpec
	Status KojiImageBuildPackageStatus
}

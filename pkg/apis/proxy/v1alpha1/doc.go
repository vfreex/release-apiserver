...
// +k8s:conversion-gen=github.com/vfreex/release-apiserver/pkg/apis/proxy
// +k8s:defaulter-gen=TypeMeta
// +groupName=proxy.art.openshift.io
package v1alpha1 // import "github.com/vfreex/release-apiserver/pkg/apis/proxy/v1alpha1"

...
var _ = Describe("SourceRevision", func() {
	var instance SourceRevision
	var expected SourceRevision
	var client SourceRevisionInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ArtV1alpha1().SourceRevisions("sourcerevision-test-valid")

...
var _ = Describe("RPMCompose", func() {
	var instance RPMCompose
	var expected RPMCompose
	var client RPMComposeInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ArtV1alpha1().RPMComposes("rpmcompose-test-valid")

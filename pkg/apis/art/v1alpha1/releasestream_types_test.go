...
import (
	...
	. "github.com/vfreex/release-apiserver/pkg/client/clientset_generated/clientset/typed/art/v1alpha1"
)

var _ = Describe("ReleaseStream", func() {
	var instance ReleaseStream
	var expected ReleaseStream
	var client ReleaseStreamInterface

	BeforeEach(func() {
		instance = ReleaseStream{}
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ArtV1alpha1().ReleaseStreams("releasestream-test-valid")

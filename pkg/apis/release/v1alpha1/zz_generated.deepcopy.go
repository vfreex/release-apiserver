...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReleaseStreamGitSource) DeepCopyInto(out *ReleaseStreamGitSource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReleaseStreamGitSource.
func (in *ReleaseStreamGitSource) DeepCopy() *ReleaseStreamGitSource {
	if in == nil {
		return nil
	}
	out := new(ReleaseStreamGitSource)
	in.DeepCopyInto(out)
	return out
}

...
import (
	...
	. "github.com/vfreex/release-apiserver/pkg/client/clientset_generated/clientset/typed/release/v1alpha1"
)
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ReleaseV1alpha1().ReleaseStreams("releasestream-test-valid")

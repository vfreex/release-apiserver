...
var (
	ApiVersion = builders.NewApiVersion("release.art.openshift.io", "v1alpha1").WithResources(
		release.ReleaseAdvisoryStorage,
		builders.NewApiResource( // Resource status endpoint
			release.InternalAdvisoryStatus,
			...
			&release.AdvisoryStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		), release.ReleaseBuildStorage,
		builders.NewApiResource( // Resource status endpoint
			release.InternalBuildStatus,
			...
			&release.BuildStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		), release.ReleaseComponentStorage,
		builders.NewApiResource( // Resource status endpoint
			release.InternalComponentStatus,
			...
			&release.ComponentStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		), release.ReleasePayloadStorage,
		builders.NewApiResource( // Resource status endpoint
			release.InternalPayloadStatus,
			...
			&release.PayloadStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		), release.ReleaseReleaseStorage,
		builders.NewApiResource( // Resource status endpoint
			release.InternalReleaseStatus,
			...
			&release.ReleaseStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		), release.ReleaseReleaseStreamStorage,
		builders.NewApiResource( // Resource status endpoint
			release.InternalReleaseStreamStatus,
			...
			&release.ReleaseStreamStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		), release.ReleaseSourceRevisionStorage,
		builders.NewApiResource( // Resource status endpoint
			release.InternalSourceRevisionStatus,
			...
			&release.SourceRevisionStatusStrategy{DefaultStatusStorageStrategy: builders.StatusStorageStrategySingleton},
		))
...
type ReleaseStreamList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ReleaseStream `json:"items"`
}

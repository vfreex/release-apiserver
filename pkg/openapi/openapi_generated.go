...
func schema_pkg_apis_release_v1alpha1_ReleaseStreamOcpBuildData(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_release_v1alpha1_ReleaseStreamSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"ocpBuildData": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/vfreex/release-apiserver/pkg/apis/release/v1alpha1.ReleaseStreamOcpBuildData"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/vfreex/release-apiserver/pkg/apis/release/v1alpha1.ReleaseStreamOcpBuildData"},
	}
}

	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ReleaseV1alpha1().Advisories(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ReleaseV1alpha1().Advisories(namespace).Watch(options)
			},
		},
		&releasev1alpha1.Advisory{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *advisoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&releasev1alpha1.Advisory{}, f.defaultInformer)
}

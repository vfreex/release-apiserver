	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ArtV1alpha1().Builds(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ArtV1alpha1().Builds(namespace).Watch(options)
			},
		},
		&artv1alpha1.Build{},
		resyncPeriod,
...
func (f *buildInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&artv1alpha1.Build{}, f.defaultInformer)
}

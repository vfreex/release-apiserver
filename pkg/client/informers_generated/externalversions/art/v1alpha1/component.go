	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ArtV1alpha1().Components(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ArtV1alpha1().Components(namespace).Watch(options)
			},
		},
		&artv1alpha1.Component{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *componentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&artv1alpha1.Component{}, f.defaultInformer)
}

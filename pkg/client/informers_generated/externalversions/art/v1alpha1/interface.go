...
type Interface interface {
	...
	// RPMComposes returns a RPMComposeInformer.
	RPMComposes() RPMComposeInformer
...
// RPMComposes returns a RPMComposeInformer.
func (v *version) RPMComposes() RPMComposeInformer {
	return &rPMComposeInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}

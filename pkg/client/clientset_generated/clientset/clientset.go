...
type Interface interface {
	...
	ArtV1alpha1() artv1alpha1.ArtV1alpha1Interface
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.artV1alpha1, err = artv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.artV1alpha1 = artv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.artV1alpha1 = artv1alpha1.New(c)

...
import (
	v1alpha1 "github.com/vfreex/release-apiserver/pkg/client/clientset_generated/clientset/typed/proxy/v1alpha1"
...
func (c *FakeProxyV1alpha1) KojiImageBuilds(namespace string) v1alpha1.KojiImageBuildInterface {

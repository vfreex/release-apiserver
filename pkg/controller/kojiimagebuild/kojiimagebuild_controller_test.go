...
func TestReconcile(t *testing.T) {
	...
	instance := &proxyv1alpha1.KojiImageBuild{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the KojiImageBuild object and expect the Reconcile

...
func TestReconcile(t *testing.T) {
	...
	instance := &releasev1alpha1.ReleaseStream{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the ReleaseStream object and expect the Reconcile
